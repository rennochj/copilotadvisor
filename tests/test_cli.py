...
def mock_collection_result():
    ...
    from document_collection.core.models import DocumentSource, SourceType, DocumentFormat
...
def test_collect_document_command_success(runner, mock_collection_result):
    ...
    with patch('document_collection.cli.main.DocumentCollectionService') as mock_service:
